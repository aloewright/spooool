// Dynamic-island table of contents for the compose wizards.
// Ported verbatim from studio/apps/web/client/components/studio/dynamic-toc.tsx.
// Only the `cn` import path changed (../../lib/utils → ../lib/utils); the
// var(--muted)/var(--foreground) tokens resolve from the .studio-scope theme
// (content-hub.css). Tailwind classes work under the scope.
