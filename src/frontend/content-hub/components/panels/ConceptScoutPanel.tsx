// Concept brief + Scout evidence — ported from
// studio/apps/web/client/components/panels/ConceptScoutPanel.tsx.
//
// Changes vs the studio source:
//   - UI primitives import from ../ui/*; api/queryKeys/types from ../../lib/api.
//
// The "Pull from Scout" action hits the live, non-deferred Scout endpoints — no
// workflow bindings involved. The mutation renders its `.error.message` inline
// and the findings query renders its own error card, so failures surface
...
export default function ConceptScoutPanel({ project }: { project: Project }): ReactNode {
