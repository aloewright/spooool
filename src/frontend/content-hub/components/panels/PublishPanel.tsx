// Publisher pack + narration + downloads — ported from
// studio/apps/web/client/components/panels/PublishPanel.tsx.
//
// Changes vs the studio source:
//   - UI primitives import from ../ui/*; api/queryKeys/types from ../../lib/api.
//   - The four helpers it needs (FIELD_SLOT_IDS, parseVoiceIds,
//     sanitizePublisherDescription, validateDraftPack) come from ./panels-shared.
//   - The two cross-route links ("Open full book", "Open Launch") are now typed
//     <Link>s to the spooool-absolute routes /studio/$projectId/book and
//     /studio/$projectId/marketplace (both registered in this PR).
//
// DEFERRED ACTIONS: "Export book", "Audition voices", and "Master audiobook"
// start the book-export / narration / audiobook-mastering workflows, which are
// guarded off until env.RENDER_WORKER / *_WORKFLOW bindings deploy. Each
// mutation renders its `.error.message` inline so a failed action surfaces the
// backend's "unavailable" message without crashing the panel. The SEO-pack
// generate / save / approve actions and the render-job polling hit live,
// non-deferred endpoints.
...
export default function PublishPanel({ project }: { project: Project }): ReactNode {
            ...
            <div className="rounded-lg border bg-background p-4">
              ...
              <div className="mt-4 rounded-md border bg-muted/20 p-4">
                ...
                <div
                  ...
                  // Sanitized via sanitizePublisherDescription before render.
          ...
          <div key={item.id} className="grid gap-3 p-3 text-sm">
            ...
            {item.audio_url ? (
              <div className="grid gap-3 sm:grid-cols-[1fr_auto] sm:items-center">
                {/* Auditions are short user-generated samples without separate transcript files yet. */}
