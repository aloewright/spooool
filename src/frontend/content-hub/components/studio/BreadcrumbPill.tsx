// Center breadcrumb / sprint-timer pill — ported verbatim from
// studio/apps/web/client/components/studio/BreadcrumbPill.tsx. No imports beyond
// react + lucide, so this is an exact copy.
