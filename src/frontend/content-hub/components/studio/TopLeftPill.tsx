// Floating "open drawer" pill — ported verbatim from
// studio/apps/web/client/components/studio/TopLeftPill.tsx. Only the import
// path to the drawer-layout store differs (../../lib/drawer-layout).
