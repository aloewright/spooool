// Scene card + AI insert bar — ported from
// studio/apps/web/client/components/studio/scene-bits.tsx. Only the relative
// import paths to ../../lib/api and ../../lib/use-autosave differ from the
// studio source; the markup and behavior are unchanged.
