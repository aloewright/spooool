// Textarea primitive — ported from
// studio/apps/web/client/components/ui/textarea.tsx. Unchanged except the `cn`
// import points at the content-hub lib/utils copy.
