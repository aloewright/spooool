// Wizard primitives for the content-hub compose flows.
// Ported verbatim from studio/apps/web/client/components/studio/wizard.tsx —
// the Tailwind classes resolve under `.studio-scope` (StudioLayout), so the
// markup is unchanged. Only the import paths differ from the studio source.
