// Script workspace — scene list. Ported from
// studio/apps/web/client/routes/_hub.scripts.$scriptId.index.tsx.
//
// Changes vs the studio source:
//   - File route (createFileRoute("/_hub/scripts/$scriptId/")) → plain
//     component (ScriptWorkspace), mounted by spooool's code-based router as the
//     index child of /studio/scripts/$scriptId (router.tsx).
        ...
        <>
          <div className="mb-8 flex items-start justify-between gap-4">
            ...
            <Link
              ...
              params={{ scriptId }}
              to="/studio/scripts/$scriptId/structure"
            >
