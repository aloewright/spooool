...
// spooool's design system (tokens in styles/themes/spooool.css) — the
// default look when the studio serves at spooool.com/studio.
export const spoooolTheme: ThemeConfig = {
  name: "spooool",
  title: "spooool",
  primaryLight: "oklch(12% 0 0)",
  primaryDark: "oklch(94% 0 0)",
  fontSans: 'Nunito, "Nunito Sans", ui-sans-serif, system-ui, sans-serif',
};

export const colorThemes = [bookCookTheme, spoooolTheme, ...themes];
