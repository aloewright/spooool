...
import { Step, ToggleChip } from "../components/studio/wizard";
import { api } from "../lib/api";

export const Route = createFileRoute("/_hub/compose-script")({ component: ComposeScript });
...
function ComposeScript() {
  ...
  const create = useMutation({
    ...
    onSuccess: ({ id }) => {
      nav({ to: "/scripts/$scriptId/structure", params: { scriptId: id } });
    },
  });
    ...
    >
      ...
      >
        <input
          ...
          // biome-ignore lint/a11y/noAutofocus: mirrors the book compose wizard
          autoFocus
